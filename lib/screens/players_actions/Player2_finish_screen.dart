...
class SecondPlayerFinish extends StatefulWidget {
  const SecondPlayerFinish({super.key});

  @override
  State<SecondPlayerFinish> createState() => _SecondPlayerFinishState();
}
...
class _SecondPlayerFinishState extends State<SecondPlayerFinish> {
  @override
  void initState() {
    super.initState();
    getWeatherForecast();
  ...
  Future<void> getWeatherForecast() {
    return Future.delayed(
        const Duration(milliseconds: 400), () => setHelpStart());
  }
      ...
      child: SizedBox(
        ...
        child: OutlinedButton(
          ...
          onPressed: () async {
            ...
            prefs.setString("NameJoin", "none");
            prefs.setString("PasswordJoin", "none");
          ...
          children: [
            StreamBuilder<QuerySnapshot>(
                ...
                builder: (
                  ...
                  return Padding(
                    ...
                    child: (data.docs[0]["player1_Finish"]
                        ? const Text("")
                        : const Text(
                            "Wait your opponent",
                            style: TextStyle(
            ...
            StreamBuilder<QuerySnapshot>(
                ...
                builder: (
                  ...
                  finishAll = data.docs[0]["player1_Lobby"];
